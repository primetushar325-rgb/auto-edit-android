...
public class ProjectStore {
    ...
    public EditProject load(){
        ...
        try{
            ...
            p.aspectRatio=AspectRatio.valueOf(o.optString("aspect",AspectRatio.R16_9.name()));
            p.exportPreset=ExportPreset.valueOf(o.optString("exportPreset",ExportPreset.LANDSCAPE_16_9.name()));
            ...
            if(arr!=null) for(int i=0;i<arr.length();i++){
                ...
                clip.durationSec=(float)c.optDouble("duration",3); clip.transition=TransitionType.valueOf(c.optString("transition",TransitionType.CROSS_DISSOLVE.name()));
